...
;;             [overtone.inst.piano]
    ...
    (definst tem [freq 440 depth 10 rate 8 length 3]
        (* 0.3
    ...
    (definst wobbled-sin [pitch-freq 540 wobble-freq 2 wobble-depth 50]
    ...
    (definst dubstep [freq 100 wobble-freq 2]
      (let [sweep (lin-exp (lf-saw wobble-freq) -1 1 40 300)
...
;;     (piano 34)
    ...
    (demo 7 (lpf (mix (saw [60 (line 100 1600 5) 101 100.5]))
                      (lin-lin (lf-tri (line 2 20 5)) -1 1 400 5000)))
