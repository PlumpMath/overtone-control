...
;; (swap!)
(assoc-in @newt/emitters [0] {:position{:x 600}})
...
(swap! newt/emitters update-in [0 :position] assoc :x 50)
...
;;     (q/ellipse x y (* y (:left state)) (* y 0.05) )
    (q/with-translation [x y 50]
      ...
      (q/box 5 )
      (q/stroke-weight 3)
      (q/stroke (q/random 255) (q/random 255) 0)
      (q/box (q/random 50))
...
;;   (q/camera 520 1029 59 499 519 178 0 -1 0 )
